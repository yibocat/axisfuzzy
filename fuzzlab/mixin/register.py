...
@register(name='reshape', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
def _reshape_impl(self, *shape: int):
    """Gives a new shape to an array without changing its data."""
    return _reshape_factory(self, *shape)


@register(name='flatten', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
def _flatten_impl(self):
    """Return a copy of the array collapsed into one dimension."""
    return _flatten_factory(self)


@register(name='squeeze', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
def _squeeze_impl(self, axis=None):
    """Remove single-dimensional entries from the shape of an array."""
    return _squeeze_factory(self, axis)


@register(name='copy', injection_type='top_level_function')
def _copy_impl(obj):
    """Returns a deep copy of the fuzzy object."""
    return _copy_factory(obj)


@register(name='ravel', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
def _ravel_impl(self):
    """Return a contiguous flattened array."""
    return _ravel_factory(self)


@register(name='transpose', injection_type='top_level_function')
...
@register(name='broadcast_to', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
def _broadcast_to_impl(self, *shape):
    """Broadcasts the fuzzy object to a new shape."""
    return _broadcast_to_factory(self, *shape)


@register(name='item', target_classes=["Fuzzarray", "Fuzznum"], injection_type='both')
...
@register(name='stack', target_classes=['Fuzzarray'], injection_type='both')
def _stack_impl(self, *others, axis: int = 0):
    """Stack Fuzzarrays along a new axis."""
    return _stack_factory(self, *others, axis=axis)


@register(name='append', target_classes=["Fuzznum", "Fuzzarray"], injection_type='both')
...
@register(name='pop', target_classes=["Fuzznum", "Fuzzarray"], injection_type='both')
