...
#                 'age_seconds': float(datetime.datetime.now().strftime("%Y%m%d%H%M%S.%f")) - self._creation_time,
...
#                     fuzznum: Fuzznum,
#                     operand: Union[int, float], **params: Any) -> Union[Fuzznum, Dict[str, Any]]:
#         """执行模糊数的指数运算。
#
