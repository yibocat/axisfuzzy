...
"""
Basic utility _components for data preprocessing and transformation.

This module provides simple, reusable _components for common data operations
...
class NormalizationTool(AnalysisComponent):
    ...
    def run(self, data: pd.DataFrame) -> Dict[str, pd.DataFrame]:
        ...
        .. code-block:: python
            ...
            import pandas as pd
            from axisfuzzy.analysis._components.basic import NormalizationTool
...
class WeightNormalizationTool(AnalysisComponent):
    ...
    def run(self, weights: WeightVector) -> Dict[str, NormalizedWeights]:
        ...
        .. code-block:: python
            ...
            import numpy as np
            from axisfuzzy.analysis._components.basic import WeightNormalizationTool
...
class StatisticsTool(AnalysisComponent):
    ...
    def run(self, data: pd.DataFrame) -> Dict[str, StatisticsDict]:
        ...
        .. code-block:: python
            ...
            import pandas as pd
            from axisfuzzy.analysis._components.basic import StatisticsTool
