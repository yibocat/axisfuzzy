...
validation and enable flexible composition of analysis _components.
...
.. code-block:: python
    ...
    correlation_matrix: ContractMatrix = np.array([[1.0, 0.8], [0.8, 1.0]])
"""
...
@register_contract('ContractMatrix')
...
# ===================================================================
# [NEW] 6. Contract Decorator for Component Methods
# ===================================================================
