...
# file: tests/analysis/test_mvp_pipeline.py
import pytest
import pandas as pd
import numpy as np

from axisfuzzy.analysis.pipeline import FuzzyPipeline
from axisfuzzy.analysis.components.fuzzify import FuzzifyComponent
from axisfuzzy.analysis.components.weighting import EntropyWeightTool
from axisfuzzy.analysis.components.aggregation import WeightedAggregationTool
from axisfuzzy.analysis.components.decision import Ranker
...
def test_end_to_end_mvp_pipeline(crisp_data):
    ...
    """
    # 1. Instantiate all necessary components with their configurations
